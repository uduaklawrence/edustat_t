...
with col_header:
    ...
    st.markdown(
         '<div class="subtitle">'
        'A high-level snapshot of the <strong>2 most recent exam years</strong> in the dataset. '
        'Figures are indicative, create a targeted report for precise, filtered insights.'
        '</div>',
        unsafe_allow_html=True,
    )
...
# -------------------- TOP EXAM CENTRES --------------------
st.markdown('<div class="section-header">Highest Candidate Registration by Exam Centre</div>', unsafe_allow_html=True)
st.markdown('<div class="chart-container">', unsafe_allow_html=True)
